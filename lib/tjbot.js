...
TJBot.prototype.see = function() {
    ...
    return new Promise(function(resolve, reject) {
        self.takePhoto().then(function(filePath) {
            resolve(self.describePhoto(filePath))
        });
    });
}

/*
Describe concepts in photo by sending it to the Watson Visual Recognition Services.
 */
TJBot.prototype.describePhoto = function(filePath) {
    this._assertCapability('see');
    ...
    return new Promise(function(resolve, reject) {
        winston.debug("sending image to Watson Visual Recognition to identify concepts");
        var params = {
...
/*
Describe text in photo by sending it to the Watson Visual Recognition Services.
 */
TJBot.prototype.describePhotoText = function(filePath) {
    this._assertCapability('see');
...
TJBot.prototype.read = function() {
    ...
    return new Promise(function(resolve, reject) {
        self.takePhoto().then(function(filePath) {
            resolve(self.describePhotoText(filePath))
        });
    });
}
...
TJBot.prototype.takePhoto = function(filePath) {
    ...
    return new Promise(function(resolve, reject) {
        self._camera.takePhoto().then(function(photobuffer) {
            resolve(path + name + "." + self._camera.getOptions().encoding);
        }).catch((error) => {
...
TJBot.prototype.play = function(soundFile) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        player.on('error', function() {
            winston.error("an audio playback error has occurred");
            reject();
        });
