    ...
    switch (service) {
        case 'assistant':
            ...
            if (credentials['username'] != undefined) {
                //Attempt service creation using usr/pass
            ...
            }else if(credentials['iam_apikey']){
                //Attempt service creation using iam_apikey
                this._assistant = new AssistantV1({
                ...
                throw new Error(
                    'No authentication credentials specified for the '+ service+' service'
                )
            }
