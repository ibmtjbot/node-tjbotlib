...
class TJBot {
    ...
    */
    ...
    constructor(configuration = {}, credentialsFile = '') {
        ...
        this.configuration = { ...TJBot.defaultConfiguration, ...configuration };

        // set logging level
        winston.level = this.configuration.log.level || 'info';
    ...
    async initialize(hardware) {
        ...
        winston.info('TJBot configured with hardware', hardware);
    }
    ...
    */
    ...
    shine(color) {
        ...
        const grb = `0x${rgb[3]}${rgb[4]}${rgb[1]}${rgb[2]}${rgb[5]}${rgb[6]}`;
