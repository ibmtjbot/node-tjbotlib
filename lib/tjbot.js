...
TJBot.prototype.see = function() {
    ...
    return self._captureAndProcessImage(this._visualRecognition.classify, this.configuration.see.confidenceThreshold.object);
}
...
TJBot.prototype.read = function() {
    this._assertCapability('see');
    return self._captureAndProcessImage(this._visualRecognition.recognizeText, this.configuration.see.confidenceThreshold.text);
}
