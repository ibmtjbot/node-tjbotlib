    ...
    switch (service) {
        ...
        case 'tone_analyzer':
            ...
            https://www.ibm.com/watson/developercloud/tone-analyzer/api/v3/
            {
                ...
                "username": "b0441a3e-22c2-4f8b-be27-f10be6a0b3ff",
                "password": "DSGqdqb5cDP7"
            }
            */
            ...
            var username = credentials['username'];
            var password = credentials['password'];
            var url = 'https://gateway.watsonplatform.net/tone-analyzer/api/';
        ...
        case 'visual_recognition':
            ...
            {
                "apikey": "BhH5xQxtTiXJz7N95LJSDz0TQ-yeGUwUqFyIq5ZhKsQb",
                "iam_apikey_description": "Auto generated apikey during resource-key operation for Instance - crn:v1:bluemix:public:watson-vision-combined:us-south:a/6cd432921b9ab8653152fa7547cd563b:ef3ab6a4-e72c-476c-9087-4311bb752cc9::",
                "iam_apikey_name": "auto-generated-apikey-a43962ca-2b9f-4e66-a80a-496b2c8a9118",
                "iam_role_crn": "crn:v1:bluemix:public:iam::::serviceRole:Manager",
                "iam_serviceid_crn": "crn:v1:bluemix:public:iam-identity::a/6cd432921b9ab8653152fa7547cd563b::serviceid:ServiceId-13b818e6-1588-4798-8b02-88d252be57cc",
            ...
            */
            ...
            var iam_apikey = credentials['apikey'];
            var url = 'https://gateway.watsonplatform.net/visual-recognition/api';
